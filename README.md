...
| File | Title | Tagline |
|------|-------|---------|
| `STORYBOARD.md` | Branded Matrix | A More Intelligent Grid · Connected. Intelligent. Global. |
| `STORYBOARD_AOAW.md` | Anatomy of a Watt | A More Intelligent Grid · told through one watt, end to end. |
| `STORYBOARD_DEMAND.md` | Demand | From Prompt to Power. |
